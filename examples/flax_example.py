...
def main(argv):
  ...
  # Createa one linear layer instance.
  ...
  def make_mse_func(x_batched, y_batched):
    def mse(params):
      ...
      # Vectorize to compute the average of the loss on all samples.
  ...
  for step in range(n_training_steps):
    ...
    # Update the optimizer state, create an update to the params.
